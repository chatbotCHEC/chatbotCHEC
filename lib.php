...
class chatBotAPI {
    ...
    public function getIndisNiu($niu){
        ...
        $json['messages'] = array(array('speech' => $this->getIndisponibilidad($niu), 'platform'=>'telegram')); 
        return $json;
    }
    ...
    public function getSPNiu($niu){
        ...
        $json['messages'] = array(array('speech' => $this->getSuspensionesProgramadas($niu), 'platform'=>'telegram')); 
        return $json;
    }
